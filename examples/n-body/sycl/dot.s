...
LBB0_5:                                 //   Parent Loop BB0_4 Depth=1
	...
	sub.rn.f32 	%f37, %f35, %f3;
	sub.rn.f32 	%f38, %f33, %f1;
	sub.rn.f32 	%f39, %f34, %f2;
	mul.rn.f32 	%f40, %f39, %f39;
	fma.rn.f32 	%f41, %f38, %f38, %f40;
	fma.rn.f32 	%f42, %f37, %f37, %f41;
	add.rn.f32 	%f43, %f42, 0f358637BE;
	mul.rn.f32 	%f44, %f43, %f43;
	mul.rn.f32 	%f45, %f43, %f44;
	mul.rn.f32 	%f46, %f45, 0fBF000000;
	mov.b32 	%r13, %f45;
	shr.s32 	%r14, %r13, 1;
	sub.s32 	%r16, %r15, %r14;
	mov.b32 	%f47, %r16;
	...
	add.rn.f32 	%f50, %f49, 0f3FC00000;
	mul.rn.f32 	%f51, %f50, %f47;
	mul.rn.f32 	%f52, %f36, %f51;
	fma.rn.f32 	%f77, %f37, %f52, %f77;
	fma.rn.f32 	%f76, %f39, %f52, %f76;
	fma.rn.f32 	%f75, %f38, %f52, %f75;
...
LBB0_7:
	...
	ld.global.v4.f32 	{%f53, %f54, %f55, %f56}, [%rd23];
	mul.rn.f32 	%f57, %f77, 0f3E4CCCCD;
	mul.rn.f32 	%f58, %f76, 0f3E4CCCCD;
	mul.rn.f32 	%f59, %f75, 0f3E4CCCCD;
	add.rn.f32 	%f60, %f53, %f59;
	add.rn.f32 	%f61, %f54, %f58;
	add.rn.f32 	%f62, %f55, %f57;
	mul.rn.f32 	%f63, %f62, 0f3F000000;
	mul.rn.f32 	%f64, %f61, 0f3F000000;
	mul.rn.f32 	%f65, %f60, 0f3F000000;
	mul.rn.f32 	%f66, %f65, 0f3E4CCCCD;
	mul.rn.f32 	%f67, %f64, 0f3E4CCCCD;
	mul.rn.f32 	%f68, %f63, 0f3E4CCCCD;
	add.rn.f32 	%f69, %f3, %f68;
	add.rn.f32 	%f70, %f2, %f67;
	add.rn.f32 	%f71, %f1, %f66;
	add.s64 	%rd24, %rd8, %rd12;
	st.global.v4.f32 	[%rd24], {%f71, %f70, %f69, %f4};
	st.global.v4.f32 	[%rd23], {%f65, %f64, %f63, %f56};
LBB0_8:
	ret;
}
                                        // -- End function
