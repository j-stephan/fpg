...
-> float3
{
    ...
    \end{minted}
    \caption{body\_body\_interaction - CUDA-Implementierung}
...
-> float3
{
    ...
    \end{minted}
    \caption{force\_calculation - CUDA-Implementierung}
...
struct block_reduce {
    ...
    \end{minted}
    \caption{Reduction - SYCL-Implementierung}
...
auto body_body_interaction(float4 bi, float4 bj, float3 ai) -> float3
{
    ...
    \end{minted}
    \caption{body\_body\_interaction - SYCL-Implementierung}
                       ...
                       unsigned tiles) -> float3
{
    ...
    \end{minted}
    \caption{force\_calculation - SYCL-Implementierung}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Performanz bei verschiedenen Kachelgrößen (SYCL)}
