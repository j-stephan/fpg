...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: Bandbreite der Vega 64 ($n = 268435456$, Lesen und Schreiben, HIP)}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: Bandbreite der Vega 64 ($n = 268435456$, Schreiben, HIP)}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title = {K20x -- zcopy -- Lesen + Schreiben -- $2^x$ -- HIP},
            xlabel = {Blöcke pro Multiprozessor},
            ylabel = {Bandbreite [\si{\gibi\byte\per\second}]},
            xmode = log,
            log basis x = 2,
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: K20x-Bandbreite für Zweierpotenzen ($n = 117440512$, Lesen und Schreiben, HIP)}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title = {K20x -- zcopy -- Schreiben -- $2^x$ -- HIP},
            xlabel = {Blöcke pro Multiprozessor},
            ylabel = {Bandbreite [\si{\gibi\byte\per\second}]},
            xmode = log,
            log basis x = 2,
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: K20x-Bandbreite für Zweierpotenzen ($n = 117440512$, Schreiben, HIP)}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title = {K20x -- zcopy -- Lesen + Schreiben -- $192 \cdot 2^x$ -- HIP},
            xlabel = {Blöcke pro Multiprozessor},
            ylabel = {Bandbreite [\si{\gibi\byte\per\second}]},
            xmode = log,
            log basis x = 2,
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: K20x-Bandbreite für 192er-Vielfache ($n = 88080384$, Lesen und Schreiben, HIP)}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title = {K20x -- zcopy -- Schreiben -- $192 \cdot 2^x$ -- HIP},
            xlabel = {Blöcke pro Multiprozessor},
            ylabel = {Bandbreite [\si{\gibi\byte\per\second}]},
            xmode = log,
            log basis x = 2,
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: K20x-Bandbreite für 192er-Vielfache ($n = 88080384$, Schreiben, HIP)}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title = {K20x -- zcopy -- Schreiben -- HIP},
            xlabel = {Blöcke pro Multiprozessor},
            ylabel = {Bandbreite [\si{\gibi\byte\per\second}]},
            xmode = log,
            log basis x = 2,
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: K20x-Bandbreite für Zweierpotenzen ($n = 117440512$) und 192er-Vielfache ($n = 88080384$, Schreiben,
             HIP)}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: K20x-Bandbreite für 768er-Blöcke ($n = 88080384$, HIP)}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title = {K20x -- zcopy -- Lesen + Schreiben -- $2^x$ -- SYCL},
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: K20x-Bandbreite für Zweierpotenzen ($n = 117440512$, Lesen und Schreiben, SYCL)}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title = {K20x -- zcopy -- Schreiben -- $2^x$ -- SYCL},
            xlabel = {Groups pro Multiprozessor},
            ylabel = {Bandbreite [\si{\gibi\byte\per\second}]},
            xmode = log,
            log basis x = 2,
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: K20x-Bandbreite für Zweierpotenzen ($n = 117440512$, Schreiben, SYCL)}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title = {K20x -- zcopy -- Lesen + Schreiben -- $192 \cdot 2^x$ -- SYCL},
            xlabel = {Groups pro Multiprozessor},
            ylabel = {Bandbreite [\si{\gibi\byte\per\second}]},
            xmode = log,
            log basis x = 2,
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: K20x-Bandbreite für 192er-Vielfache ($n = 88080384$, Lesen und Schreiben, SYCL)}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title = {K20x -- zcopy -- Schreiben -- $192 \cdot 2^x$ -- SYCL},
            xlabel = {Groups pro Multiprozessor},
            ylabel = {Bandbreite [\si{\gibi\byte\per\second}]},
            xmode = log,
            log basis x = 2,
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: K20x-Bandbreite für 192er-Vielfache ($n = 88080384$, Schreiben, SYCL)}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title = {K20x -- zcopy -- Schreiben -- SYCL},
            xlabel = {Groups pro Multiprozessor},
            ylabel = {Bandbreite [\si{\gibi\byte\per\second}]},
            xmode = log,
            log basis x = 2,
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: K20x-Bandbreite für 768er-Groups ($n = 88080384$, SYCL)}
\end{figure}
