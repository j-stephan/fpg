...
Auch im \gls{gpgpu}-Kontext ist die Reduktion früh untersucht worden; der
Harris stellte 2007 eine optimierte Reduktion für CUDA vor
(vgl.~\cite{harris2007}). 
...
void tile_calculation(float4* x, float3* a)
{
    ...
    int unit_id = group_idx * group_dim + unit_idx;

    float4 my_position = x[unit_id];
