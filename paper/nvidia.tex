...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title = {K20x -- zcopy -- Lesen + Schreiben -- generisch},
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: K20x-Bandbreite für generische Blöcke (Lesen und Schreiben, CUDA)}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title = {K20x -- zcopy -- Schreiben -- generisch},
            xlabel = {Blöcke pro Multiprozessor},
            ylabel = {Bandbreite [\si{\gibi\byte\per\second}]},
            xmode = log,
            log basis x = 2,
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: K20x-Bandbreite für generische Blöcke (Schreiben, CUDA)}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title = {K20x -- zcopy -- Lesen + Schreiben -- optimiert},
            xlabel = {Blöcke pro Multiprozessor},
            ylabel = {Bandbreite [\si{\gibi\byte\per\second}]},
            xmode = log,
            log basis x = 2,
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: K20x-Bandbreite für optimierte Blöcke (Lesen und Schreiben, CUDA)}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title = {K20x -- zcopy -- Schreiben -- optimiert},
            xlabel = {Blöcke pro Multiprozessor},
            ylabel = {Bandbreite [\si{\gibi\byte\per\second}]},
            xmode = log,
            log basis x = 2,
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: K20x-Bandbreite für optimierte Blöcke (Schreiben, CUDA)}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            title = {K20x -- zcopy -- Schreiben -- generisch und optimiert},
            xlabel = {Blöcke pro Multiprozessor},
            ylabel = {Bandbreite [\si{\gibi\byte\per\second}]},
            xmode = log,
            log basis x = 2,
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: K20x-Bandbreite für generische und optimierte Blöcke
             (Schreiben, CUDA)}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: K20x-Bandbreite für 768er-Blöcke (CUDA)}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: K20x-Bandbreite für 768er-Blöcke (Schreiben)}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{zcopy: Theoretische und praktische K20x-Bandbreite für 768er-Blöcke}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{N-Body: Leistungsvergleich zwischen CUDA und HIP}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{N-Body: Leistungsvergleich zwischen CUDA (mit Q\_rsqrt) und SYCL}
